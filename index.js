...
let grid = [];
let savedData;
rowButton.addEventListener("click", () => {rows = parseInt(rowInput.value); console.log(rows)});
colButton.addEventListener(
  "click",
  () => {columns = parseInt(colInput.value); console.log(columns)}
);
let count = 0;
